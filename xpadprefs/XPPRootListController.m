...
- (void)respring {
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"XPXPad" message:@"Respring now to apply changes?" preferredStyle:UIAlertControllerStyleAlert];
    ...
    UIAlertAction *respringAction = [UIAlertAction actionWithTitle:@"Yes" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
        ...
        NSURL *relaunchURL = [NSURL URLWithString:@"prefs:root=XPXPad"];
