...
@implementation XPPKeyboardTypeOptions
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
    switch (section) {
        case 0:
            return @"Enabled Input Type";
        case 1:
            return @"Disabled Input Type";
        default:
            return @"";
    }
}
...
- (NSString *)tableView:(UITableView *)tableView titleForFooterInSection:(NSInteger)section
{
    switch (section) {
        case 0:
            return @"Enabled input will be cycled when shorcut is tapped. \"Default\" type will be skipped if it is same as \"Original\". Set a minimum of 2 items, including Original.\n\nNOTE: Some input doesn't support changing input type, DockX indicates it by changing the current icon to hollow/grey.";
        case 1:
            return @"";
        default:
            return @"";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    XPPCustomActionViewController *actionViewController = [[CustomActionViewController alloc] init];
...
- (void)updateOrder:(BOOL)reset{
    ...
    NSArray *defaultOrderLabel = @[@"Original", @"Default", @"Decimal Pad", @"Number Pad", @"URL", @"eMail", @"ASCII", @"Numbers And Punctuation", @"Phone Pad", @"Name & Phone Pad", @"Twitter", @"Web Search", @"Number Pad (ASCII)", @"Alphabet"];
    NSArray *defaultOrderData = @[@-1, @0, @8, @4, @3, @7, @1, @2, @5, @6, @9, @10, @11, @12];
...
-(void)reset{
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"DockX" message:@"Reset to default?" preferredStyle:UIAlertControllerStyleAlert];
...
- (void)viewDidLoad {
    ...
    ((UIViewController *)self).title = @"Keyboard Input";
