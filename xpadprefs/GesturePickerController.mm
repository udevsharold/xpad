...
- (NSArray *)specifiers {
    if (!_specifiers) {
        ...
        PSSpecifier *longPressSpec = [PSSpecifier preferenceSpecifierNamed:@"Long Press" target:nil set:nil get:nil detail:NSClassFromString(@"GesturePickerController") cell:PSLinkListCell edit:nil];
        [longPressSpec setProperty:@"Long Press" forKey:@"label"];
        [snippetEntrySpecifiers addObject:longPressSpec];
        
        PSSpecifier *doubleTapSpec = [PSSpecifier preferenceSpecifierNamed:@"Double Tap" target:nil set:nil get:nil detail:NSClassFromString(@"GesturePickerController") cell:PSLinkListCell edit:nil];
