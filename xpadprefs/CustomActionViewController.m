...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch(indexPath.section) {
        case 0: {
            ...
            label = [XPadHelper labelFromArray:self.fullOrder[0] atIndex:indexPath.row];
            image = [XPadHelper imageFromArray:self.fullOrder[0] atIndex:indexPath.row withSystemColor:YES completion:^(BOOL thirteen, BOOL customPath){
                isThirteen = thirteen;
        ...
        case 1: {
            ...
            label = [XPadHelper labelFromArray:self.fullOrder[1] atIndex:indexPath.row];
            image = [XPadHelper imageFromArray:self.fullOrder[1] atIndex:indexPath.row withSystemColor:YES completion:^(BOOL thirteen, BOOL customPath){
                isThirteen = thirteen;
                isCustomImagePath = customPath;
                dispatch_semaphore_signal(smp);
            }];
